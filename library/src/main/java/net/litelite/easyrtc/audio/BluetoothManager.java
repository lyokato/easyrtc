...
Most of this code is copied from AppRTCBluetoothManager
 */
...
public class BluetoothManager {
  ...
  private final AudioController apprtcAudioManager;
  ...
  /** Construction. */
  static BluetoothManager create(Context context, AudioController audioManager) {
    Log.d(TAG, "create" + RTCUtils.getThreadInfo());
    return new BluetoothManager(context, audioManager);
  }

  protected BluetoothManager(Context context, AudioController audioManager) {
    Log.d(TAG, "ctor");
   ...
   * Note that the AudioController is also involved in driving this state
   * change.
   */
  public void start() {
    ThreadUtils.checkIsOnMainThread();
