package net.litelite.easyrtc.audio;
...
import net.litelite.easyrtc.util.RTCUtils;
...
/*
 * Most of this code is copied from AudioController
 *
 * It's really useful but it depends on PreferenceManager and R.string.pref_speakerphone_key
 * I would like to remove this dependencies, and make it more general one.
 */
...
public class AudioController {
    ...
    private AudioControllerState amState;
    ...
    private void onProximitySensorChangedState() {
        ...
        if (audioDevices.size() == 2 && audioDevices.contains(AudioController.AudioDevice.EARPIECE)
                && audioDevices.contains(AudioController.AudioDevice.SPEAKER_PHONE)) {
            if (proximitySensor.sensorReportsNearState()) {
                // Sensor reports that a "handset is being held up to a person's ear",
                // or "something is covering the light sensor".
                setAudioDeviceInternal(AudioController.AudioDevice.EARPIECE);
            } else {
                // Sensor reports that a "handset is removed from a person's ear", or
                // "the light sensor is no longer covered".
                setAudioDeviceInternal(AudioController.AudioDevice.SPEAKER_PHONE);
            }
        }
    }
    ...
    public static AudioController create(Context context) {
        return new AudioController(context, "auto");
    }
    public static AudioController create(Context context, String useSpeakerphone) {
        return new AudioController(context, useSpeakerphone);
    }

    private AudioController(Context context, String speakerphone) {
        Log.d(TAG, "ctor");
        ...
        amState = AudioControllerState.UNINITIALIZED;
    ...
    public void start(AudioManagerEvents audioManagerEvents) {
        Log.d(TAG, "start");
        ThreadUtils.checkIsOnMainThread();
        if (amState == AudioControllerState.RUNNING) {
        ...
        amState = AudioControllerState.RUNNING;
